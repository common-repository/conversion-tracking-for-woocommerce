 ...
 */
class Conversion_Tracking_For_WooCommerce {
	/**
	 *
	 * @var self
	 */
	...
	private function order_json($order) {
		...
		if (!$customer) {
			$customer = array(
				...
				"name_first" => $order->get_billing_first_name(null),
				"name_last" => $order->get_billing_last_name(null)
			);
		}
		return array(
			'order' => array(
...
Conversion_Tracking_For_WooCommerce::singleton();
